...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        self.Frame1.configure(border="10")
        ...
        self.Message6.configure(text='''WELCOME TO SYSTEM''')
        ...
        self.Button2.configure(text='''1. ALLOCATE ROOM''')
        ...
        self.Button3.configure(text='''2.SHOW ALLOCATTED ROOM LIST''')
        self.Button3.configure(width=566)
        self.Button3.configure(command=click_list)
        self.Button3.configure(border="10")
        ...
        self.Button4.configure(border="10")
        ...
        self.Button5.configure(text='''4.GET INFO OF ANY ROOM''')
        self.Button5.configure(width=566)
        self.Button5.configure(command=click_getinfo)
        self.Button5.configure(border="10")
        ...
        self.Button6.configure(border="10")
        root.mainloop()
